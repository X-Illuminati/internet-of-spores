...
void EPD_1in9_Easy_Write_Full_Screen(float temp, float humidity, bool fahrenheit=false, bool connect=false,
  bool connection_error=false, bool low_battery=false, bool critical_battery=false);
